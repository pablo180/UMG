<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Productos.aspx.vb" Inherits="privado_Productos" %>
...
<head>
  ...
  <title>Productos | <%=datos.addKey("NameProject")%></title>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> Productos <span>Catalogos...</span></h2>
    </div>
    ...
    <div class="modal-content">
        ...
        <input type="hidden" id="Hidden1" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                <input type="text" id="txtMDCodigo"  name="txtMDCodigo" class="form-control" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ClientIDMode="Static" ID="DropProveedor" runat="server" style="width:100%;"></asp:DropDownList>
                </div>
                <label class="col-md-2">Unidad:</label>
                <div class="col-md-4">
                    <asp:DropDownList ClientIDMode="Static" ID="DropDUnidad" runat="server" style="width:100%;"></asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2">Categoria:</label>
                <div class="col-md-4">
                    <asp:DropDownList ClientIDMode="Static" ID="DropCategoria" runat="server" style="width:100%;"></asp:DropDownList>
                </div>
...
<script src="js/funciones/Productos.js?v=1"></script>
