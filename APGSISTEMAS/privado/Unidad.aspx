<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Unidad.aspx.vb" Inherits="privado_Unidad" %>
...
<head>
  ...
  <title>Unidad | <%=datos.addKey("NameProject")%></title>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> Unidad <span>Catalogos...</span></h2>
    </div>
...
<script src="js/funciones/Unidad.js?v=1"></script>
