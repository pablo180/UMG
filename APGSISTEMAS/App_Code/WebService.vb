...
Public Class WebService
    ...
    Public Function BuscarProveedorNit(ByVal nit As String) As List(Of [ClassProveedor])
        ...
        Using conexion As New MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("Conn").ConnectionString)
            Try
                conexion.Open()
                consulta = "select Nit,Nombre from cliente where Nit='" & nit & "';"
                Dim cmd As New MySqlCommand(consulta, conexion)
                Dim reader As MySqlDataReader = cmd.ExecuteReader()
                While reader.Read
    ...
    Public Function GuardarFacturaViaticos(ByVal FechaFactura As String, ByVal NitProveedor As String, ByVal NombreProveedor As String, ByVal SerieFactura As String, ByVal NumeroFactura As String, ByVal Observacion As String, ByVal Detalle As List(Of ClassRecibeDetalleFactura)) As List(Of [ClassFacturaViaticos])
        ...
        Using conexion As New MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("Conn").ConnectionString)
            ...
            Try
                If Not datos.ExisteDato("SELECT Nit, Nombre FROM cliente where Nit='" & NitProveedor & "';") Then
                    comando.CommandType = Data.CommandType.Text
                    Dim InsertProveedor As String = "INSERT INTO cliente (Nit, Nombre, Direccion, celular) VALUES ('" & NitProveedor & "','" & NombreProveedor & "',' ', '00000000')"
                ...
                MySQLInsert = "INSERT INTO facturacion (id_borrar, fecha, usuario, serie, nofac, departamento, provedor, comprador, recibe, descrip, tipo_fac, descuento, status, nempresa, tipo_doc, retencion, tipo_pago, Vehiculo, OrdenTrabajo, Liquidado, Versatec)VALUES" _
                            + "(1, '" & FechaFactura & "', '" & Context.Request.Cookies("UserSettings")("user") & "', '" & SerieFactura & "', '" & NumeroFactura & "','" & Departamento & "', '" & NitProveedor & "', '" & Context.Request.Cookies("UserSettings")("IdPersonal") & "','" & Context.Request.Cookies("UserSettings")("IdPersonal") & "','" & Observacion & "', 1, 0, 1, 23, '1', 0, 1, '1','0',0,0)"
